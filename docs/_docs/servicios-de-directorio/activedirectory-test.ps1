$db = [ordered]@{
    "ou=ASIR1,dc=iescanarias,dc=es" = [ordered]@{
        "objectClass" = "organizationalUnit"
    }

    "cn=Charles Bronson,ou=ASIR1,dc=iescanarias,dc=es" = [ordered]@{
        "objectClass" = "user"
        "givenName" = "Charles"
        "surname" = "Bronson"
    ...
    "cn=Chuck Norris,ou=ASIR1,dc=iescanarias,dc=es" = [ordered]@{
        "objectClass" = "user"
        "givenName" = "Chuck"
        "surname" = "Norris"
    ...
    "cn=Clint Eastwood,ou=ASIR1,dc=iescanarias,dc=es" = [ordered]@{
        "objectClass" = "user"
        "givenName" = "Clint"
        "surname" = "Eastwood"
        "mail" = "clint@yahoo.es"
    ...
    "cn=Michael Knight,ou=ASIR1,dc=iescanarias,dc=es" = [ordered]@{
        "objectClass" = "user"
        "givenName" = "Michael"
        "surname" = "Knight"
    ...
    "cn=AlumnosASIR1,ou=ASIR1,dc=iescanarias,dc=es" = [ordered]@{
        "objectClass" = "group"
        "members" = @(
    ...
    "cn=ProfesoresASIR1,ou=ASIR1,dc=iescanarias,dc=es" = [ordered]@{
        "objectClass" = "group"
        "members" = @(
    ...
    "ou=ASIR2,dc=iescanarias,dc=es" = [ordered]@{
        "objectClass" = "organizationalUnit"
    }

    "cn=MA Barracus,ou=ASIR2,dc=iescanarias,dc=es" = [ordered]@{
        "objectClass" = "user"
        "givenName" = "MA"
        "surname" = "Barracus"
    ...
    "cn=Phoenix Johnson,ou=ASIR2,dc=iescanarias,dc=es" = [ordered]@{
        "objectClass" = "user"
        "givenName" = "Phoenix"
        "surname" = "Johnson"
    ...
    "cn=Anibal Smith,ou=ASIR2,dc=iescanarias,dc=es" = [ordered]@{
        "objectClass" = "user"
        "givenName" = "Anibal"
        "surname" = "Smith"
    ...
    "cn=Murdock Sánchez,ou=ASIR2,dc=iescanarias,dc=es" = [ordered]@{
        "objectClass" = "user"
        "givenName" = "Murdock"
        "surname" = "Sánchez"
    ...
    "cn=AlumnosASIR2,ou=ASIR2,dc=iescanarias,dc=es" = [ordered]@{
        "objectClass" = "group"
        "members" = @(
    ...
    "cn=ProfesoresASIR2,ou=ASIR2,dc=iescanarias,dc=es" = [ordered]@{
        "objectClass" = "group"
        "members" = @(
            "cn=Ángel Pérez,ou=Profesores,dc=iescanarias,dc=es"
    ...
    "ou=Profesores,dc=iescanarias,dc=es" = [ordered]@{
        "objectClass" = "organizationalUnit"
    }

    "cn=Francisco Vargas,ou=Profesores,dc=iescanarias,dc=es" = [ordered]@{
        "objectClass" = "user"
        "givenName" = "Francisco"
        "surname" = "Vargas"
    ...
    "cn=Ángel Pérez,ou=Profesores,dc=iescanarias,dc=es" = [ordered]@{
        "objectClass" = "user"
        "givenName" = "Ángel"
        "surname" = "Pérez"
    ...
    "cn=Paco González,ou=Profesores,dc=iescanarias,dc=es" = [ordered]@{
        "objectClass" = "user"
        "givenName" = "Paco"
        "surname" = "González"
    ...
    "cn=Profesores,ou=Profesores,dc=iescanarias,dc=es" = [ordered]@{
        "objectClass" = "group"
        "members" = @(
            "cn=Francisco Vargas,ou=Profesores,dc=iescanarias,dc=es"
            "cn=Ángel Pérez,ou=Profesores,dc=iescanarias,dc=es"
